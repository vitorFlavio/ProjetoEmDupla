...
int main(){
    ...
    while (opcao != 0){
        ...
        if (opcao == 1){
            ...
            //MINI GAME
            float v=100,valorUsu;
            int n,valor1mini[n],valor2mini[n],resultado[n],jordane,acertos=0,erros=0;
            printf("Informe a quantidade de tentativas que você quer no mini game\n");
            scanf("%d",&n);
            
            printf("Informe o que quer tentar: multiplicação=1, soma=2, subtração=3, divisão= 4\n");
            scanf("%d", &jordane);
