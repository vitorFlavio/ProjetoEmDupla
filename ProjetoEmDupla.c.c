...
int main(){
    ...
    while (opcao != 0){
        ...
        if (opcao == 1){
            ...
            int c, d, e, f, i, j, k;
            printf("Entre com o número de linhas de A\n");
                scanf("%d", &c);
            printf("Entre com o número de colunas de A\n");
                scanf("%d", &d);
            printf("Entre com o número de linhas de B\n");
                scanf("%d", &e);
            printf("Entre com o número de colunas de B\n");
                scanf("%d", &f);
